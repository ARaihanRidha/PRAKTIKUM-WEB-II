    ...
    <div class="centered-content">
        <div class="table-container">
            ...
            <table border="1" cellpadding="10" cellspacing="0" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="formPeminjaman.php?id_peminjaman=<?= $row['id_peminjaman']; ?>" class="btn btn-warning btn-sm">Ubah</a>
                            <a href="hapus.php?id_peminjaman=<?= $row['id_peminjaman']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <div class="d-flex flex-row">
                <a href="formPeminjaman.php" class="btn btn-primary d-flex justify-content-start" style="width: fit-content;">Tambah List Peminjaman</a>
